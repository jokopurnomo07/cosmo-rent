...
<head>
  ...
  <link rel="stylesheet" crossorigin href="{{ asset('admin') }}/assets/compiled/css/error.css">
</head>
...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <div class="text-center">
            <img class="img-error" src="{{ asset('admin') }}/assets/compiled/png/animal.png" alt="System Error">
            <h1 class="error-title">Pembayaran Telah Berhasil</h1>
            <p class="fs-5 text-gray-600">Anda nanti akan dihubungi oleh tim kami, untuk melakukan penyerahan kendaraan.</p>
